...
public class ConnectionHandler<T> {
	...
	private ProtocolCallback<T> myCallback;
	...
	private void initialize() {
	        ...
	        public void sendMessage(T msg) {
	    		if ((msg != null) && (msg != ""))
	    		{
	    			try {
						...
						logger.info("Error from sending in connection handler");
						e.printStackTrace();
					}
	    		}
	       }
		...
		_task = new ProtocolTask<T>(_protocol, _tokenizer, this, myCallback);
